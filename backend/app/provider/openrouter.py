...
class OpenRouterProvider(OpenAICompatProvider):
    ...
    async def list_models(self) -> list[ModelInfo]:
        ...
        # Inject platform free virtual models only on the WorkCraft proxy instance.
        # User BYOK OpenRouter instances must not surface "workcraft/best-free" —
    ...
    async def stream_chat(
        ...
        *,
        ...
        # Translate WorkCraft virtual model IDs only for direct OpenRouter calls.
