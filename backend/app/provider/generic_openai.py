...
with fallback to the bundled provider catalog, then to the provider's own
...
class GenericOpenAIProvider(OpenAICompatProvider):
    ...
    async def list_models(self) -> list[ModelInfo]:
        """Return models with metadata from models.dev, bundled catalog, and API."""
    ...
    def _load_catalog_models(self) -> list[ModelInfo]:
        """Fallback: load from the bundled provider catalog."""
        try:
