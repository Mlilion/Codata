...
Translates between OpenAI Chat Completions format (used internally by WorkCraft)
...
class OpenAISubscriptionProvider(BaseProvider):
    ...
    async def _do_refresh(self) -> None:
        ...
        _update_env_file("WORKCRAFT_OPENAI_OAUTH_ACCESS_TOKEN", self._access_token)
        if tokens.get("refresh_token"):
            _update_env_file("WORKCRAFT_OPENAI_OAUTH_REFRESH_TOKEN", self._refresh_token)
        _update_env_file("WORKCRAFT_OPENAI_OAUTH_EXPIRES_AT", str(new_expires_at))
