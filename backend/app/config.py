...
class Settings(BaseSettings):
    ...
    openai_api_key: str = ""        # WORKCRAFT_OPENAI_API_KEY
    openai_base_url: str = "https://aihub2.top/v1"  # WORKCRAFT_OPENAI_BASE_URL
    anthropic_api_key: str = ""     # WORKCRAFT_ANTHROPIC_API_KEY
    google_api_key: str = ""        # WORKCRAFT_GOOGLE_API_KEY
    groq_api_key: str = ""          # WORKCRAFT_GROQ_API_KEY
    deepseek_api_key: str = ""      # WORKCRAFT_DEEPSEEK_API_KEY
    mistral_api_key: str = ""       # WORKCRAFT_MISTRAL_API_KEY
    xai_api_key: str = ""           # WORKCRAFT_XAI_API_KEY
    together_api_key: str = ""      # WORKCRAFT_TOGETHER_API_KEY
    deepinfra_api_key: str = ""     # WORKCRAFT_DEEPINFRA_API_KEY
    cerebras_api_key: str = ""      # WORKCRAFT_CEREBRAS_API_KEY
    cohere_api_key: str = ""        # WORKCRAFT_COHERE_API_KEY
    perplexity_api_key: str = ""    # WORKCRAFT_PERPLEXITY_API_KEY
    fireworks_api_key: str = ""     # WORKCRAFT_FIREWORKS_API_KEY
    azure_openai_api_key: str = ""  # WORKCRAFT_AZURE_OPENAI_API_KEY
    azure_openai_base_url: str = "" # WORKCRAFT_AZURE_OPENAI_BASE_URL
    qwen_api_key: str = ""          # WORKCRAFT_QWEN_API_KEY (Alibaba DashScope)
    kimi_api_key: str = ""          # WORKCRAFT_KIMI_API_KEY (Moonshot)
    minimax_api_key: str = ""       # WORKCRAFT_MINIMAX_API_KEY
    zhipu_api_key: str = ""         # WORKCRAFT_ZHIPU_API_KEY (智谱 GLM)
    siliconflow_api_key: str = ""   # WORKCRAFT_SILICONFLOW_API_KEY (硅基流动)
    xiaomi_api_key: str = ""        # WORKCRAFT_XIAOMI_API_KEY (MiMo)
    custom_endpoints: str = "[]"    # WORKCRAFT_CUSTOM_ENDPOINTS
    ...
    local_base_url: str = ""  # WORKCRAFT_LOCAL_BASE_URL
    ...
    extra_allowed_origins: str = ""  # WORKCRAFT_EXTRA_ALLOWED_ORIGINS

    # --- Messaging Channels (nanobot-based, in-process) ---
    channels_enabled: bool = True  # WORKCRAFT_CHANNELS_ENABLED
    channels_config_path: str = ""  # WORKCRAFT_CHANNELS_CONFIG_PATH (default: data/channels.json)

    # --- Remote Expert Teams (manifest adapter, disabled by default) ---
    remote_expert_teams_enabled: bool = False  # WORKCRAFT_REMOTE_EXPERT_TEAMS_ENABLED
    ...
    remote_expert_teams_cache_path: str = ""  # default: ~/.workcraft/remote-expert-teams/cache/manifest.json
    ...
    # the ``WORKCRAFT_SESSION_TOKEN_PATH`` env var when the contract differs
