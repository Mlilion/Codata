...
_expert_team_registry: ExpertTeamRegistry | None = None


def set_expert_team_registry(r: ExpertTeamRegistry) -> None:
    global _expert_team_registry
    _expert_team_registry = r


def get_expert_team_registry() -> ExpertTeamRegistry:
    if _expert_team_registry is None:
        raise RuntimeError("ExpertTeamRegistry not initialized")
    return _expert_team_registry


ExpertTeamRegistryDep = Annotated[ExpertTeamRegistry, Depends(get_expert_team_registry)]

# ---------------------------------------------------------------------------
# Expert role registry
# ---------------------------------------------------------------------------

_expert_role_registry: ExpertRoleRegistry | None = None


def set_expert_role_registry(r: ExpertRoleRegistry) -> None:
    global _expert_role_registry
    _expert_role_registry = r


def get_expert_role_registry() -> ExpertRoleRegistry:
    if _expert_role_registry is None:
        raise RuntimeError("ExpertRoleRegistry not initialized")
    return _expert_role_registry


ExpertRoleRegistryDep = Annotated[ExpertRoleRegistry, Depends(get_expert_role_registry)]
