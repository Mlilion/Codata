...
# Product-supported built-in channels. Other channel modules may still exist
# in the source tree, but discovery and API loading are intentionally limited
# to this list.
SUPPORTED_CHANNELS = frozenset({"dingtalk", "feishu", "weixin", "wecom", "qq", "telegram"})
...
def load_channel_class(module_name: str) -> type[BaseChannel]:
    ...
    if module_name not in SUPPORTED_CHANNELS:
        raise ImportError(f"Unsupported channel: {module_name}")
