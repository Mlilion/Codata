...
class ProviderToggleUpdate(BaseModel):
    """Request to idempotently enable or disable a built-in provider."""
...
class ProviderTestResult(BaseModel):
    """Result from validating a provider connection without persisting it."""
