...
_MODIFYING_TOOLS = frozenset({"edit", "write", "bash", "code_execute", "create_expert_teams"})
                        ...
                        case "tool-call":
                            ...
                            if not _exec_blocked:
                                ...
                                _ctx = ToolContext(
                                    ...
                                    allowed_file_paths=_allowed_attachment_paths(sp.request.attachments),
                                ...
                                _ctx._app_state = {  # type: ignore[attr-defined]
                                    ...
                                    "tool_registry": sp.tool_registry,
                                    "expert_team_registry": getattr(sp, "expert_team_registry", None),
                                    "expert_role_registry": getattr(sp, "expert_role_registry", None),
                                    "skill_registry": getattr(sp, "skill_registry", None),
                                    "settings": _cfg(),
                                }
                                _ctx._model_id = sp.model_id  # type: ignore[attr-defined]
                                _ctx._provider_id = sp.provider.id  # type: ignore[attr-defined]
