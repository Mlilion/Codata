...
interface SettingsStore {
  ...
  /** Default model ID used when a conversation has no explicit selection */
  defaultModel: string | null;
  /** Provider ID for the default model */
  ...
  /** Set default model and its provider */
  setDefaultModel: (model: string | null, providerId?: string | null) => void;
...
export const useSettingsStore = create<SettingsStore>()(
  persist(
    (set, get) => ({
      ...
      setDefaultModel: (model, providerId) => set({ defaultModel: model, defaultProviderId: providerId ?? null }),
