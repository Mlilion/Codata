...
function MultiQuestionPrompt({
  ...
  const hasOptions = useCallback((question: QuestionItem | undefined) => {
                      ...
                      <div className="space-y-2">
                        {hasOptions(q) ? (
                          ...
                          <textarea
                            ...
                            placeholder={t("typeAnswer")}
                            rows={4}
                            className="w-full resize-none rounded-xl border border-[var(--border-default)] bg-[var(--surface-secondary)] px-3 py-3 text-base text-[var(--text-primary)] outline-none focus:ring-1 focus:ring-[var(--ring)]"
                          />
                        )}
                      </div>
                    </div>
            ...
            <div className={`flex gap-4 ${hasPreview ? "" : ""}`}>
              ...
              <div className={`space-y-1.5 ${hasPreview ? "flex-1" : "w-full"}`}>
                {hasOptions(currentQ) ? (
                  ...
                  <textarea
                    value={(answers[currentQ.question] as string) || ""}
                    onChange={(e) => setAnswer(currentQ.question, e.target.value)}
                    placeholder={t("typeAnswer")}
                    rows={5}
                    className="w-full resize-none rounded-lg border border-[var(--border-default)] bg-[var(--surface-secondary)] px-3 py-2 text-sm text-[var(--text-primary)] outline-none focus:ring-1 focus:ring-[var(--ring)]"
                  />
                )}
              </div>
