...
import { Copy, Check, RefreshCw, ThumbsUp, ThumbsDown, ListTree, RotateCcw } from "lucide-react";
...
export function MessageActions({ content, onRegenerate, activityData, activityKey, onResumeExpert }: MessageActionsProps) {
  ...
  return (
    <div className="flex items-center gap-0.5 pt-2">
      ...
      {onResumeExpert && (
        <button
          type="button"
          onClick={onResumeExpert}
          className="flex items-center justify-center h-7 w-7 rounded-md text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-secondary)] transition-colors"
          aria-label="Resume expert team"
          title="从失败步骤继续"
        >
