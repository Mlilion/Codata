...
// us, so this cache stays null in web mode.
 ...
 * Tauri IPC on first call, then cached. Only meaningful on desktop.
 *
 * Retry behaviour
 * ---------------
...
export const API = {
  ...
  CONFIG: {
    ...
    PROVIDER_TEST: (id: string) => `/api/config/providers/${id}/test` as const,
    PROVIDER_TOGGLE: (id: string) => `/api/config/providers/${id}/toggle` as const,
    CUSTOM_ENDPOINT: "/api/config/custom",
    CUSTOM_ENDPOINT_TEST: "/api/config/custom/test",
  ...
  EXPERT_TEAMS: {
    LIST: "/api/expert-teams",
    CREATE: "/api/expert-teams",
    GENERATE: "/api/expert-teams/generate",
    VALIDATE: "/api/expert-teams/validate",
    DETAIL: (id: string) => `/api/expert-teams/${encodeURIComponent(id)}` as const,
    UPDATE: (id: string) => `/api/expert-teams/${encodeURIComponent(id)}` as const,
    DELETE: (id: string) => `/api/expert-teams/${encodeURIComponent(id)}` as const,
    SUMMON: (id: string) => `/api/expert-teams/${encodeURIComponent(id)}/summon` as const,
    RESUME: (id: string, sessionId: string) =>
      `/api/expert-teams/${encodeURIComponent(id)}/sessions/${encodeURIComponent(sessionId)}/resume` as const,
  },
  EXPERT_ROLES: {
    LIST: "/api/expert-roles",
    DETAIL: (id: string) => `/api/expert-roles/${id}` as const,
    REFRESH: "/api/expert-roles/refresh",
  },
  AUTOMATIONS: {
  ...
  CHANNELS: {
    ...
    WEIXIN_QR_START: "/api/channels/weixin/qr/start",
    WEIXIN_QR_STATUS: (sessionId: string) =>
      `/api/channels/weixin/qr/${encodeURIComponent(sessionId)}` as const,
    WEIXIN_QR_CANCEL: (sessionId: string) =>
      `/api/channels/weixin/qr/${encodeURIComponent(sessionId)}/cancel` as const,
    FEISHU_QR_START: "/api/channels/feishu/qr/start",
    FEISHU_QR_STATUS: (sessionId: string) =>
      `/api/channels/feishu/qr/${encodeURIComponent(sessionId)}` as const,
    FEISHU_QR_CANCEL: (sessionId: string) =>
      `/api/channels/feishu/qr/${encodeURIComponent(sessionId)}/cancel` as const,
  },
  WORKSPACE_MEMORY: {
...
export const queryKeys = {
  ...
  skillDetail: (name: string) => ["skills", name] as const,
  ...
  expertTeams: {
    all: ["expertTeams"] as const,
    detail: (id: string) => ["expertTeams", id] as const,
  },
  expertRoles: ["expertRoles"] as const,
